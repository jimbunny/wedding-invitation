...
**/
	...
	$.fn.barrage = function(opt){
		...
		M.barrageBox = $('<div id="barrage" style="z-index:999;max-width:100%;margin-left:5px;margin-bottom:-40px;position:'+settings.position+';'+M.vertical+':0;'+M.horizontal+':0;"></div>'); //存所有弹幕的盒子
		M.timer = null; 
