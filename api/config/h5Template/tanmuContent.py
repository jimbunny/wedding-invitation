...
<div class="maka-barrage-dom" style="top: 0px; left: 0px; background-color: transparent; z-index: 1000;">
    ...
    <div class="barrage-bottom row" id="barrageBtn" style=" margin-bottom: 7px; padding-bottom: env(safe-area-inset-bottom); position: relative; min-height: 35.7422px; width: 100%;">
    ...
    <div class="barrage-btn tanBtn" style="padding-bottom: env(safe-area-inset-bottom); margin-top: 14.0625px; position: fixed; left: 11.7188px; bottom: 20px; pointer-events: initial;">
